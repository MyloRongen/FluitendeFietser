...
<body id="fietsen">
  ...
  <header>
    ...
    <section>
        ...
        <div id="fietsenafb2">
            <figure>
            <figcaption id="figlaag">Pelikaan Carry On Lady</figcaption>
            <a><img id="a11" src="afb/fietsen/1.jpg" onclick="afb1();"></a>
            </figure>
          ...
          <table id="tablesize2">
            ...
            <tr>
              <td>opmerkingen</td>
              <td>28 Inch 53 cm 3V V-Brakes</td>
            </tr>
          </table>     
          <input type="submit" id="buttonkopen" value="Kopen">

          <input type="hidden" name="naam" id="naam" value="Pelikaan Carry On Lady">
          <input type="hidden" name="prijs" id="prijs" value="769,00">
          </form>
        </div>
        </div>
