...
<div id="id01" class="model">
  ...
  <form class="model-content animatie" action="registercode.php" method="post" autocomplete="off">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Voer een wachtwoord in" name="password" id="password" required>

      <label for="email"><b>E-mail</b></label>
      <input type="text" placeholder="Voer een e-mail in" name="email" id="email" required>
