...
<body id="fietsen">
  ...
  <header>
    ...
    <section>
        ...
        <div id="fietsenafb2">
            <figure>
            <figcaption id="figlaag">Allegra voorwielmotor</figcaption>
            <a><img id="a11" src="afb/fietsen/2.jpg" onclick="afb1();"></a>
            </figure>
          ...
          <table id="tablesize2">
            ...
            <tr>
              <td>opmerkingen</td>
              <td>frameraat S (Lichaamslengte 1,62m - 1,73m)</td>
            </tr>
          </table>     
          <input type="submit" id="buttonkopen" value="Kopen">

          <input type="hidden" name="naam" id="naam" value="Allegra voorwielmotor">
          <input type="hidden" name="prijs" id="prijs" value="999,00">
          </form>
        </div>
        </div>
